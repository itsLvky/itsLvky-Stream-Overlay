...
import {
  StreamerbotProvider,
  useStreamerbot,
  type StreamerbotInitialState,
} from '@/app/components/overlay/StreamerbotContext'
...
export default function AfkContent({ initialState }: { initialState?: StreamerbotInitialState }) {
  return (
